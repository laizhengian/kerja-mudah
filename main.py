...
T = {
    "en": {
        ...
        "email_copied": "Email content copied to clipboard. Paste into Gmail/Outlook/etc.",
    ...
    "ms": {
        ...
        "email_copied": "Kandungan emel disalin ke papan klip. Tampal ke Gmail/Outlook/dll.",
    ...
    "zh": {
        ...
        "email_opened": "邮件已打开",
        "email_copied": "邮件内容已复制到剪贴板。粘贴到Gmail/Outlook等。",
